 ...
 * @returns
 */
export const getBanners = (type = 0) => api.get('/banner', { params: { type } })

/**
 *  获取推荐 mv
 * @returns
 */
export const getPersonalizedMV = () => api.get('/personalized/mv')
 ...
 * @returns
 */
export const getPersonalized = (limit = 30) => api.get('/personalized', { params: { limit } })
 ...
 * @returns
 */
export const getPersonalizedNewSong = (limit = 10) => api.get('/personalized/newSong', { params: { limit } })

/**
 * 获取推荐电台
 * @returns
 */
export const getPersonalizedDjProgram = () => api.get('/personalized/djprogram')

/**
 *  获取推荐节目
 * @returns
 */
export const getProgramRecommend = () => api.get('/program/recommend')

/**
 *  获取独家放送(入口列表)
 * @returns
 */
export const getPersonalizedPrivateContent = () => api.get('/personalized/privatecontent')
 ...
 * @returns
 */
export const getPersonalizedPrivateContentList = params => api.get('/personalized/privatecontent/list', { params })
 ...
 * @returns
 */
export const getToplistArtist = (type = 1) => api.get('/toplist/artist', { params: { type } })
 ...
 * @returns
 */
export const getTopSong = type => api.get('/top/song', { params: { type } })
 ...
 * @returns
 */
export const getTopAlbum = params => api.get('/top/album', { params })
 ...
 * @returns
 */
export const getCommentHot = params => api.get('/comment/hot', { params })
