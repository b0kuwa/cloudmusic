 ...
 * @LastEditTime: 2022-08-29 23:34:58
...
<template>
	<div class="flex mb-4">
		<div class="album cursor-pointer">
			...
			<!-- 播放图标 -->
			<span
				class="iconfont icon-play1 play-icon absolute-center"
				@click="playAll"
			></span>
		</div>
		<div class="flex-1 cursor-default ml-5 flex flex-col justify-between">
			<ul>
				<li
					...
					:key="item.id"
					class="hover:bg-gray-100 flex items-center justify-between px-2 py-1"
				>
			...
			<span @click="goMore" class="text-sm text-gray-600 hover:text-gray-800"
...
import MImage from '../m-image/index.vue'
export default {
	name: 'RankItem',
	props: {
		id: {
