<template>
    <div>
        ...
        <div v-loading="loading"
            ...
            >
                <playlist-item :label="item.name" :src="item.coverImgUrl" :num="item.playCount"
                               :image-style="{width:'100%',height:'190px'}"></playlist-item>
            </router-link>
        </div>
        <!-- 分页 -->
...
.bg {
    @apply w-full h-full absolute rounded-md bg-no-repeat bg-center bg-current bg-cover blur-2xl filter;
